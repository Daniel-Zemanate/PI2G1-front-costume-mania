...
function Dropdown({ buttonIcon, buttonText, children }: Props) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 min-w-[14rem] whitespace-nowrap origin-top-right rounded-xl bg-white shadow-lg border border-purple-2 p-4 overflow-hidden">
          {children}
        </Menu.Items>
      </Transition>
    </Menu>
